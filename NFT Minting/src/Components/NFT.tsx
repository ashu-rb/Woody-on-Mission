                            ...
                            <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                                ...
                                <div className='flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t'>
                                    <h3 className='text-3xl font-semibold'>
                                        ...
                                        {loggedInUser && !isMinted && 'Cowboy NFT'}
                                        {isMinted && 'Minted!'}
                                    </h3>
                                    <button
                                ...
                                <div className='relative p-6 flex-auto'>
                                    ...
                                    <br></br>
                                            ...
                                            <div>
                                            <a href={`https://wa.me/?text=https://node.deso.org/posts/${mintedPostHashHex}`} data-action="share/whatsapp/share" className="my-6 px-14 py-3 bg-gray-900 hover:bg-gray-800 rounded-md shadown-md text-white">Share on Whatsapp</a>
                                            <a href={`https://www.facebook.com/sharer/sharer.php?u=https://node.deso.org/posts/${mintedPostHashHex}`} data-action="share/whatsapp/share" className="my-6 px-12 py-3 bg-gray-900 hover:bg-gray-800 rounded-md shadown-md text-white">Share on Facebook</a>
                                            <a href={`https://twitter.com/intent/tweet?text=https://node.deso.org/posts/${mintedPostHashHex}`} data-action="share/whatsapp/share" className="my-6 px-14 py-3 bg-gray-900 hover:bg-gray-800 rounded-md shadown-md text-white">Share on Twitter</a>
                                            </div>
